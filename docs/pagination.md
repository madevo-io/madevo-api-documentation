...
The Madevo API uses a combination of page-based and cursor-based pagination depending on the endpoint.
...
Some endpoints internally support pagination but do not expose a `page` parameter.
